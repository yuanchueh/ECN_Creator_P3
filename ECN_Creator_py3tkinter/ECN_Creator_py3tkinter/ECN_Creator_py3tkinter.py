...
class MainFrame(ttk.Frame):
    ...
    _product = _('Template') + ': Py3Tkinter_ECNCreator'
...
class MenuBar(tkinter.Menu):
    ...
    def help_dialog(self, event):
        ...
        PopupDialog(self, 'Py3Tkinter_ECNCreator', _description)

    def about_dialog(self):
        "Dialog concerning information about entities responsible for program."

        _description = 'A program to take a list of PDF files in a directory structure and create a formatted ECN list.'
        if _description == '':
            _description = _('No description available')
        _description += '\n'
        _description += '\n' + _('Author') + ': Jim West'
        _description += '\n' + _('Email') + ': yuanchueh@gmail.com'
        _description += '\n' + _('Version') + ': 0.0.1'
        _description += '\n' + _('GitHub Package') + \
                        ': ECN_Creator_py3tkinter'
        PopupDialog(self, _('About') + ' Py3Tkinter_ECNCreator',
                    _description)
...
class Application(tkinter.Tk):
    ...
    def __init__(self):
        ...
        self.wm_title('Py3Tkinter_ECNCreator')
