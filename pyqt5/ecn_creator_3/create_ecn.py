...
class ECN_Creator_3(QMainWindow):
    """Create the main window that stores all of the widgets necessary for the application."""

    def __init__(self, parent=None):
        """Initialize the components of the main window."""
        super(ECN_Creator_3, self).__init__(parent)
        self.resize(1024, 768)
        self.setWindowTitle('ECN_Creator_3')
        window_icon = pkg_resources.resource_filename('ecn_creator_3.images',
    ...
    def file_menu(self):
        ...
        self.open_action.setStatusTip('Open a file into ECN_Creator_3.')
